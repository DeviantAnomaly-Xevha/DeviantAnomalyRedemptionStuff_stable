...
namespace DeviantAnomalyRedemptionStuff_stable.Content.Projectiles.XenomiteCrystalBomb
{
    public class XenomiteCrystalBombLeftHalf_Proj : ModProjectile
    {
        ...
        public override bool OnTileCollide(Vector2 oldVelocity)
        {
            ...
            int a = Projectile.NewProjectile(Projectile.InheritSource(Projectile), new Vector2(Projectile.Center.X, Projectile.Center.Y - 9), new Vector2(0, 12f), Mod.Find<ModProjectile>($"XenomiteCrystalPillar_{Main.rand.Next(1, 5)}_2_Proj").Type, Projectile.damage, 0, Main.myPlayer);
